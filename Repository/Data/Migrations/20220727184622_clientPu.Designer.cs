...
namespace Repository.Data.Migrations
{
    ...
    [Migration("20220727184622_clientPu")]
    partial class clientPu
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClientData.Models.Client", b =>
                {
            ...
            modelBuilder.Entity("ClientData.Models.Diplome", b =>
                {
            ...
            modelBuilder.Entity("ClientData.Models.Document", b =>
                {
            ...
            modelBuilder.Entity("ClientData.Models.Formation", b =>
                {
            ...
            modelBuilder.Entity("ClientData.Models.InscriptionFormation", b =>
                {
            ...
            modelBuilder.Entity("PlateformeDesJeunes.Models.ClientPublic", b =>
                {
                    b.Property<int>("ClientPublicID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ClientData.Models.Diplome", b =>
                {
                    b.HasOne("ClientData.Models.Client", "Client")
                        .WithMany("Diplomes")
                        .HasForeignKey("ClientID");

                    b.HasOne("PlateformeDesJeunes.Models.ClientPublic", "ClientPublic")
                        .WithMany("Diplomes")
                        .HasForeignKey("ClientPublicID");

                    b.Navigation("Client");

                    b.Navigation("ClientPublic");
                });
            ...
            modelBuilder.Entity("ClientData.Models.InscriptionFormation", b =>
                {
                    ...
                    b.HasOne("PlateformeDesJeunes.Models.ClientPublic", null)
                        .WithMany("InscriptionFormation")
                        .HasForeignKey("ClientPublicID");

                    b.HasOne("ClientData.Models.Formation", "Formation")
                        .WithMany("InscriptionFormation")
